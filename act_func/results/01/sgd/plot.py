...
def activation_functions_mean_std(act_func, errorevery=10, savepath=''):
    ...
    # plt.plot(range(len(act1_mean)), act1_mean, color=husl[2], label='Layer 1')
    # plt.plot(act1_mean + act1_std, '--', color=husl[2])
    # plt.plot(act1_mean - act1_std, '--', color=husl[2])
    # plt.fill_between(range(len(act1_mean)), act1_mean,
    #                  act1_mean+act1_std, alpha=0.05, facecolor=husl[2])
    # plt.fill_between(range(len(act1_mean)), act1_mean,
    #                  act1_mean-act1_std, alpha=0.05, facecolor=husl[2])

    # plt.plot(range(len(act2_mean)), act2_mean, color=husl[4], label='Layer 2')
    # plt.plot(act2_mean + act2_std, '--', color=husl[4])
    # plt.plot(act2_mean - act2_std, '--', color=husl[4])
    # plt.fill_between(range(len(act2_mean)), act2_mean,
    #                  act2_mean+act2_std, alpha=0.05, facecolor=husl[4])
    # plt.fill_between(range(len(act2_mean)), act2_mean,
    #                  act2_mean-act2_std, alpha=0.05, facecolor=husl[4])
    # plt.plot(range(len(act3_mean)), act3_mean, color=husl[9], label='Layer 3')
    # plt.plot(act3_mean + act3_std, '--', color=husl[9])
    # plt.plot(act3_mean - act3_std, '--', color=husl[9])
    # plt.fill_between(range(len(act3_mean)), act3_mean,
    #                  act3_mean+act3_std, alpha=0.1, facecolor=husl[9])
    # plt.fill_between(range(len(act3_mean)), act3_mean,
    #                  act3_mean-act3_std, alpha=0.1, facecolor=husl[9])

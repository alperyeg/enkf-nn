...
if __name__ == '__main__':
    ...
    # gradients_dist_layer(gradients, savepath=os.path.join(path, 'sgd_grad_distribution_per_layer.eps'))
    # gradients_mean_std(gradients, savepath=os.path.join(path, 'sgd_grad_mean_std_all.eps'))
